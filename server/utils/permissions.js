...
export const authPermission = createResolver((parent, args, { user }) => {
  if (!user || !user.id) {
    throw new Error("Not authenticated");
  }
});

export const teamAccessPermission = createResolver(
...
export const directMessagePermission = createResolver(
